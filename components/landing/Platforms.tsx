const PLATFORMS = [
  { name: "LeetCode", color: "#FFA116", note: "The default for interview-style problems" },
  { name: "CodeChef", color: "#5B4638", note: "Rated contests and long-format challenges" },
  { name: "Codeforces", color: "#1F8ACB", note: "Competitive programming rounds and rating" },
  { name: "GeeksforGeeks", color: "#2F8D46", note: "Concept-first practice by topic" },
  { name: "HackerRank", color: "#00EA64", note: "Structured tracks and certification tests" },
];
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {PLATFORMS.map((p) => (
            <div key={p.name} className="card p-4 text-center">
              <div
                className="mx-auto flex h-10 w-10 items-center justify-center rounded-full text-sm font-semibold text-ink-fixed"
