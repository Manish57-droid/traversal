...
export default function TopicsIndexPage() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-display text-2xl text-fg sm:text-3xl">DSA topics</h1>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {CONCEPT_TOPICS.map((topic) => (
          <Link key={topic.slug} href={`/topics/${topic.slug}`} className="card block p-5 transition-colors hover:border-line">
            <p className="font-display text-xl text-fg">{topic.title}</p>
